...
The raw data was downloaded from here:<br>
...
THE FOLLOWING IS REPRINTED FROM THE FEATURES_INFO.TXT INCLUDED IN THE SOURCE ZIPPED ARCHIVE:<br>
...
<end reprint from features_info.txt>
